    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="py-12 border-b border-gray-800">
            <div class="max-w-2xl mx-auto text-center">
                <h2 class="text-2xl font-bold text-white sm:text-3xl">Suscríbete a nuestro boletín</h2>
                <p class="mt-4 text-gray-400">Recibe las últimas actualizaciones y ofertas especiales directamente en tu bandeja de entrada.</p>
                <form class="mt-6 sm:flex sm:max-w-md mx-auto">
                    <label for="email-address" class="sr-only">Correo electrónico</label>
                    <input type="email" id="email-address" autocomplete="email" required class="w-full min-w-0 px-4 py-3 rounded-md border-0 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-indigo-500 sm:text-sm" placeholder="Ingresa tu email">
                    <button type="submit" class="mt-3 w-full bg-indigo-600 px-6 py-3 rounded-md text-white font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0 transition-colors duration-200">Suscribirse</button>
                </form>
            </div>
        </div>
        <div class="py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                <h3 class="text-white font-semibold text-lg">Legal</h3>
                <ul class="space-y-2">
        ...
        <div class="border-t border-gray-800 py-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 text-sm">
                <p class="text-gray-500">© <span id="current-year">2023</span> Tu Empresa. Todos los derechos reservados.</p>
                <div class="hidden sm:block h-4 w-px bg-gray-700"></div>
                <div class="flex gap-4">
                    <a href="#" class="text-gray-500 hover:text-white transition-colors duration-200">Política de privacidad</a>
                    <a href="#" class="text-gray-500 hover:text-white transition-colors duration-200">Términos de servicio</a>
                </div>
            </div>
        </div>
    </div>
