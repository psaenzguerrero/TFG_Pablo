        ...
        <div class="flex flex-wrap">
            ...
            <div class="block w-full md:fixed md:h-screen md:overflow-y-auto md:w-72 bg-gradient-to-b from-indigo-50 to-white p-6 border-r border-indigo-100 shadow-lg">
                ...
                <form method="POST" action="index.php" class="space-y-6">
                    ...
                    <button type="submit" class="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-3 px-4 rounded-lg shadow-md hover:shadow-lg hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0">
                        Aplicar Filtros
                    </button>
                </form>

                <?php if (isset($_SESSION["id_usuario"]) && strcmp($_SESSION["tipo_usuario"], "Admin") == 0): ?>
                    <a href="./index.php?action=agregarProducto" class="mt-4 inline-flex items-center justify-center w-full bg-green-500 text-white py-2 px-4 rounded-lg shadow hover:bg-green-600 transition-colors">
            ...
            <div class="md:ml-72 p-8 flex-1">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php foreach ($productos as $producto): ?>
                        <div class="bg-white p-5 rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 cursor-pointer transform hover:-translate-y-1 border border-gray-100 hover:border-indigo-100 group" onclick="abrirModal(<?php echo htmlspecialchars($producto['id_producto']); ?>)">
                            <div class="relative">
